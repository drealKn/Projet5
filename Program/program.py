...
Téléchargements des produits : 
    ...
    def menu(self):
        ...
        n = input("Entrez le numéro d'une catégorie ou q pour quitter puis appuyez sur <Entrée> :")
    ...
    def category_choice(self, choices):
        ...
        n = input("Entrez le numéro d'une catégorie ou q pour revenir au menu principal puis appuyez sur <Entrée> :")
    ...
    def product_choice(self, products):
        ...
        n = input("Entrez le numéro d'un produit ou q pour revenir au menu principal puis appuyez sur <Entrée> :")
        while n not in n_list and n.lower() != "q":
            print("Vous n'avez pas entré une valeur valide")
            n = input("Entrez le numéro d'un produit ou q pour revenir au menu principal puis appuyez sur <Entrée> :")
        if n in n_list:           
    ...
    def substitute_choice(self, substitutes):
        ...
        n = input("Entrez le numéro d'un produit pour l'ajouter en tant que favoris ou q pour revenir au menu principal puis appuyez sur <Entrée> :")
        while n not in n_list and n.lower() != "q":
            print("Vous n'avez pas entré une valeur valide")
            n = input("Entrez le numéro d'un produit ou q pour revenir au menu principal puis appuyez sur <Entrée> :")
        if n in n_list:           
            ...
            n = input("Entrez q pour revenir au menu principal puis appuyez sur <Entrée> :")
            while n != "q":
                print("Vous n'avez pas entré une valeur valide")
                n = input("Entrez q pour revenir au menu principal puis appuyez sur <Entrée> :")
            if n.lower() == "q":
